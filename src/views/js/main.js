...
function updatePositions(movingPizzaElems, phaseModulator, numMovingPizzas) {
  ...
  */
  ...
  for (var i = 0, phase; i < numMovingPizzas; i++) {
    phase = Math.sin(scaledScrollTop + (i % phaseModulator));
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0, elem; i < numMovingPizzas; i++) {
  ...
  var movingPizzaElems = document.getElementsByClassName('mover');
